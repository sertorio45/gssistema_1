  ...
  <div>
    <div class="p-6">
      <div class="mb-6 flex items-center justify-between">
        ...
        <Button class="bg-primary hover:bg-primary/90" @click="() => navigateTo('/articles/tag')">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-12">
            ...
            <CardContent class="space-y-6">
              ...
              <div class="space-y-2">
                ...
                <div class="flex gap-2">
                  <Input id="slug" v-model="form.slug" placeholder="tag-slug" :disabled="loading" required />
          ...
          <Card class="md:col-span-4">
            <CardHeader>
              ...
              <CardDescription> Set the publication status for this tag </CardDescription>
            </CardHeader>
            <CardContent class="space-y-6">
              <div class="space-y-2">
                <Label>Status</Label>
